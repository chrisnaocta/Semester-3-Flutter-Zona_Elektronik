...
import 'package:zona_elektronik/reset_password.dart';
import 'dart:convert';
...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      var uri = Uri.http('10.0.2.2', '/Zona_Elektronik/forgot_password.php');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _message = "Error (Status Code: ${response.statusCode})";
        });
      }
    } catch (e) {
